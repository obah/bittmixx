use super::honk_verifier_circuits::{
    is_on_curve_bn254, run_GRUMPKIN_ZKHONK_PREP_MSM_SCALARS_SIZE_13_circuit,
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_13_circuit,
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_13_circuit,
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_13_circuit,
    run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_13_PUB_19_circuit,
};
...
#[starknet::contract]
pub mod UltraStarknetZKHonkVerifier {
    ...
    use super::{
        ...
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_13_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_13_circuit,
        run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_13_PUB_19_circuit, vk,
    };
    ...
    impl IUltraStarknetZKHonkVerifier of super::IUltraStarknetZKHonkVerifier<ContractState> {
        fn verify_ultra_starknet_zk_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_13_PUB_19_circuit(
            ...
            let mut scalars: Span<u384> = array![
                ...
                scalar_49, scalar_50, scalar_51, scalar_52, scalar_53, scalar_69, scalar_70,
                scalar_71, transcript.shplonk_z.into(), scalar_72,
            ]
                .span();
